...
%%% Set theme %%%
\usetheme{ICRAR} %using Dingo theme
...
\author[Krist\'of Rozgonyi]{\textbf{Krist\'of Rozgonyi{\Large \inst{1,}\inst{2}}}\\ {\Large Supervisors: Martin Meyer{\large \inst{1,}\inst{2}}\\\hskip 60pt Chen Wu{\large \inst{1,}\inst{2}}\\\hskip 60pt Richard Dodson{\large \inst{1,}\inst{2}}}} %Note that the inst signs fontsize have to be set here to match with author size 
\date[today]{\today}
...
\begin{frame}{Frame titles are centered}
